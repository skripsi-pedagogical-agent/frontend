    ...
    >
      ...
      <div className={cn(
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className={cn("font-black tracking-tight", embedded ? "text-sm" : "text-base")}>Bamboost</h3>
            <div className="flex items-center gap-1.5">
              <div className="w-1.5 h-1.5 bg-emerald-400 rounded-full animate-pulse" />
              <span className="text-[10px] font-black text-emerald-100 uppercase tracking-widest">Tutor Mode</span>
            </div>
          </div>
        </div>
        {!embedded && (
          ...
          >
            {messages.length === 0 && (
              <div className="h-full flex flex-col items-center justify-center text-center p-8 space-y-4">
                ...
                <div>
                  <p className="text-base font-black text-emerald-950">Chew on a problem?</p>
                  <p className="text-xs text-emerald-900 mt-1 font-black">I'm here to help you plan, debug, or optimize your code!</p>
                </div>
              </div>
            )}
            {messages.map((msg) => (
              ...
              >
                <div className={cn(
                  ...
                  msg.role === 'user' ? "bg-emerald-300 text-emerald-900" : "bg-emerald-800 text-white"
                )}>
